...
// Source reference: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
// Embedded to avoid runtime file dependency.
static const char* const BIP39_EN_WORDS[2048] = {
...
"dynamics","eager","eagle","early","earn","earth","easily","east","easy","echo",
"ecology","economy","edge","edit","educate","effort","egg","eight","either","elbow",
"elder","electric","elegant","element","elephant","elevator","elite","else","embark","embody",
"embrace","emerge","emotion","employ","empower","empty","enable","encourage","end","endorse",
...
"hiking","hill","hint","hip","hire","history","hobby","hockey","hold","hole",
"holiday","hollow","home","honey","hood","hope","horn","horror","horse","hospital",
"host","hotel","hour","hover","hub","huge","human","humble","humor","hundred",
"hunger","hunter","hybrid","ice","icon","idea","identify","idle","ignore","ill",
...
"mercury","merge","merit","merry","mesh","message","metal","method","middle","midnight",
...
"profile","profit","program","project","promote","proof","property","prosper","protect","proud",
